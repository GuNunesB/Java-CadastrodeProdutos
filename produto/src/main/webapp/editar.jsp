...
<meta name="description" content="Sistema de cadastro de produtos com Java e Bootstrap.">
<meta name="keywords" content="cadastro, produtos, sistema, Java, Bootstrap">
					...
					<form id="form_produto" name="frmProduto" action="update">
						...
						<div class="form-group">
							<label for="qtde">Quantidade</label> <input type="number"
								...
								placeholder="Digite a quantidade" aria-required="true"
								value="<%out.print(request.getAttribute("qtde"));%>" required>
						</div>

						<div class="form-group">
							<label for="valor_unit">Valor Unitário</label> <input type="text"
								class="form-control" name="valorunit" id="valor_unit"
								placeholder="Ex: 12,99" pattern="^\d+(,\d{1,2})?$"
						...
						<div class="form-group">
							<label for="data">Data de Cadastro</label> <input type="date"
								class="form-control" name="data_cad" id="data"
								aria-required="true"
